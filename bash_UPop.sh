#!/bin/bash
#SBATCH --job-name=CLIP_compress_2
#SBATCH --partition=a6000_ada

#SBATCH --gres=gpu:4
#SBATCH --cpus-per-task=64
#SBATCH --mem-per-cpu=8G
#SBATCH --output=output_dir/CLIP_compress_result_2.txt
#SBATCH --error=output_dir/CLIP_compress_error_2.txt
...
singularity exec --nv \
  ...
  --pretrained pretrained/clip_large_retrieval_coco.pth --config ./configs/retrieval_coco_clip_2.yaml \
  --output_dir output_dir/CLIP_compress_2/x75   > output_dir/CLIP_compress_2.txt
'
