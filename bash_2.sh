#!/bin/bash
#SBATCH --job-name=UPop0709
#SBATCH --partition=a6000_ada
#SBATCH --gres=gpu:4
#SBATCH --cpus-per-task=64
#SBATCH --mem-per-cpu=8G
#SBATCH --output=output_dir/x75_UPop0709/UPop0709_result.txt
#SBATCH --error=output_dir/x75_UPop0709/UPop0709_error.txt
...
singularity exec --nv \
  ...
  --output_dir output_dir/x75_UPop0709 --make_sim_matrix  > output_dir/x75_UPop0709/UPop0709_log.txt
'
