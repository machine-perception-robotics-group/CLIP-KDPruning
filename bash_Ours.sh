#!/bin/bash
#SBATCH --job-name=CLIP_compress
#SBATCH --partition=a100
#SBATCH --gres=gpu:4
#SBATCH --cpus-per-task=64
#SBATCH --mem-per-cpu=8G
#SBATCH --output=output_dir/CLIP_compress_result.txt
#SBATCH --error=output_dir/CLIP_compress_error.txt
...
singularity exec --nv \
  ...
  --output_dir output_dir/CLIP_compress/x75 --KD  > output_dir/CLIP_compress.txt
'
